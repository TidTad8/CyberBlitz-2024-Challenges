...
Difficulty: Easy
Prerequisites: Nil
Requirements: Geospatial data, python, inference

## Narrative:
Hmm... there is an unknown  file and a caller conversation history…
...
## Challenge breakdown:
- Players to comprehend the call conversation history and identify points of interest and infer the respective SIT campuses
- Map out the SIT campuses into a loop (red dot.. LOL) using google maps to determine total accumulated distance (60.04km direct mapping using measure tool, 79.0km by google routing  using transport)
- Python file with a script to execute formula
- Players are prompted to enter distance and receive flag


*Flag:* ~~CyberBlitz{c0nn3ct1ng_th3_d0ts_1n_pr0gr3ss}~~